...
from .models import MLP, SimpleCNNModel1, SimpleCNNModel2, SimpleCNNModel3, SimpleCNNModel4, SimpleCNNModel5, SimpleCNNModel6
from ._utils import _prepare_classification_dataset, ClassificationDataset


def hyperparameter_model_search(classification_id: str,
    ...
    models = [SimpleCNNModel3, SimpleCNNModel4, SimpleCNNModel5, SimpleCNNModel6]
    ...
    output_file = os.path.join(output_dir, f"model_search_{classification_id}.csv")
            ...
            for batch_size in batch_sizes:
                ...
                for epoch in range(num_epochs):
                    ...
                    with open(output_file, "a") as file:
                        file.write(f"{classification_id},{model_class.__name__},{lr},"
