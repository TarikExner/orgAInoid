...
def generate_subfigure_b(fig: Figure,
    ...
    with open("./figure_data/RPE_classification_test_neural_net_confusion_matrices.data", "rb") as file:
        test_data = utils._preprocess_two_class_results(pickle.load(file))

    with open("./figure_data/RPE_classification_val_neural_net_confusion_matrices.data", "rb") as file:
        val_data = utils._preprocess_two_class_results(pickle.load(file))
...
def generate_subfigure_d(fig: Figure,
    ...
    with open("./figure_data/Lens_classification_test_neural_net_confusion_matrices.data", "rb") as file:
        test_data = utils._preprocess_two_class_results(pickle.load(file))

    with open("./figure_data/Lens_classification_val_neural_net_confusion_matrices.data", "rb") as file:
        val_data = utils._preprocess_two_class_results(pickle.load(file))
...
if __name__ == "__main__":
    ...
    plt.savefig("./prefinal_figures/FigureS6.pdf", dpi = 300, bbox_inches = "tight")
    plt.savefig("./prefinal_figures/FigureS6.png", dpi = 300, bbox_inches = "tight")
    plt.show()
