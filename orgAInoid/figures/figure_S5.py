...
def _generate_main_figure(
    ...
    def generate_subfigure_a(
        ...
        clf_comp_plot.set_title(
            f"Classifier performance for RPE emergence\non image projection {proj}",
    ...
    def generate_subfigure_b(
        ...
        clf_comp_plot.set_title(
            f"Classifier performance for lens emergence\non image projection {proj}",
            fontsize=cfg.TITLE_SIZE,
        )
        clf_comp_plot.set_ylabel("F1 Score", fontsize=cfg.AXIS_LABEL_SIZE)
        clf_comp_plot.set_xticklabels(
...
def figure_S5_generation(
    ...
    rpe_output_dir = os.path.join(figure_output_dir, "Extended_Data_17.csv")
    rpe_final_clf.to_csv(rpe_output_dir, index = False)

    lens_output_dir = os.path.join(figure_output_dir, "Extended_Data_18.csv")
