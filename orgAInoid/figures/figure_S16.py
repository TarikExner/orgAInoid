...
def _generate_main_figure(
    ...
    def generate_subfigure_a(
        ...
        clf_comp_plot.set_title(
            f"Classifier performance for RPE classes\non image projection {proj}",
    ...
    def generate_subfigure_b(
        ...
        clf_comp_plot.set_title(
            f"Classifier performance for lens classes\non image projection {proj}",
            fontsize=cfg.TITLE_SIZE,
        )
        clf_comp_plot.set_ylabel("F1 Score", fontsize=cfg.AXIS_LABEL_SIZE)
        clf_comp_plot.set_xticklabels(
...
def figure_S16_generation(
    ...
    _generate_main_figure(
        ...
        figure_name="Supplementary_Figure_S16",
    )

    rpe_output_dir = os.path.join(figure_output_dir, "Data_S1_SF16a.csv")
    ...
    lens_output_dir = os.path.join(figure_output_dir, "Data_S1_SF16b.csv")
