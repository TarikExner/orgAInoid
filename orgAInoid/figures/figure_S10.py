...
def figure_S10_generation(
    ...
    **kwargs,
    ...
    rpe_final_output_dir = os.path.join(figure_output_dir, "Extended_Data_33.csv")
    rpe_final_f1s.to_csv(rpe_final_output_dir, index = False)

    rpe_clf_output_dir = os.path.join(figure_output_dir, "Extended_Data_34.csv")
    ...
    lens_final_output_dir = os.path.join(figure_output_dir, "Extended_Data_35.csv")
    lens_final_f1s.to_csv(lens_final_output_dir, index = False)

    lens_clf_output_dir = os.path.join(figure_output_dir, "Extended_Data_36.csv")
