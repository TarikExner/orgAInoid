...
def figure_S10_generation(
    ...
    **kwargs,
    ...
    rpe_clf_output_dir = os.path.join(figure_output_dir, "S34_Data.csv")
    ...
    lens_final_output_dir = os.path.join(figure_output_dir, "S35_Data.csv")
    lens_final_f1s.to_csv(lens_final_output_dir, index = False)

    lens_clf_output_dir = os.path.join(figure_output_dir, "S36_Data.csv")
