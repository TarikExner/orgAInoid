...
def figure_S9_generation(
    ...
    **kwargs,
    ...
    rpe_final_output_dir = os.path.join(figure_output_dir, "S29_Data.csv")
    rpe_final_f1s.to_csv(rpe_final_output_dir, index = False)

    rpe_clf_output_dir = os.path.join(figure_output_dir, "S30_Data.csv")
    ...
    lens_final_output_dir = os.path.join(figure_output_dir, "S31_Data.csv")
    lens_final_f1s.to_csv(lens_final_output_dir, index = False)

    lens_clf_output_dir = os.path.join(figure_output_dir, "S32_Data.csv")
