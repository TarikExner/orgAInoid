...
def figure_S9_generation(
    ...
    **kwargs,
    ...
    rpe_clf_test_cm = create_confusion_matrix_frame(
        readout="RPE_Final",
    ...
    rpe_clf_val_cm = create_confusion_matrix_frame(
        readout="RPE_Final",
        classifier="classifier",
        eval_set="val",
        proj="sum",
    ...
    lens_clf_test_cm = create_confusion_matrix_frame(
        readout="Lens_Final",
        classifier="classifier",
        eval_set="test",
        proj="sum",
    ...
    lens_clf_val_cm = create_confusion_matrix_frame(
        readout="Lens_Final",
        classifier="classifier",
        eval_set="val",
        proj="sum",
    ...
    rpe_final_output_dir = os.path.join(figure_output_dir, "Extended_Data_29.csv")
    rpe_final_f1s.to_csv(rpe_final_output_dir, index = False)

    rpe_clf_output_dir = os.path.join(figure_output_dir, "Extended_Data_30.csv")
    ...
    lens_final_output_dir = os.path.join(figure_output_dir, "Extended_Data_31.csv")
    lens_final_f1s.to_csv(lens_final_output_dir, index = False)

    lens_clf_output_dir = os.path.join(figure_output_dir, "Extended_Data_32.csv")
    lens_clf_test_cm["eval_set"] = "val"
    lens_clf_val_cm["eval_set"] = "test"
    lens_clf = pd.concat([lens_clf_test_cm, lens_clf_val_cm], axis = 0)
    lens_clf.to_csv(lens_clf_output_dir, index = False)
