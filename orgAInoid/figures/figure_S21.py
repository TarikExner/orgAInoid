...
def figure_S21_generation(
    ...
    **kwargs,
    ...
    rpe_final_output_dir = os.path.join(figure_output_dir, "S68_Data.csv")
    rpe_classes_f1s.to_csv(rpe_final_output_dir, index = False)

    rpe_clf_output_dir = os.path.join(figure_output_dir, "S69_Data.csv")
    ...
    lens_final_output_dir = os.path.join(figure_output_dir, "S70_Data.csv")
    lens_classes_f1s.to_csv(lens_final_output_dir, index = False)

    lens_clf_output_dir = os.path.join(figure_output_dir, "S71_Data.csv")
