...
def figure_S17_generation(
    ...
    _generate_main_figure(
        ...
        figure_name="Supplementary_Figure_S17",
    )

    rpe_output_dir = os.path.join(figure_output_dir, "Data_S1_SF17a.csv")
    ...
    lens_output_dir = os.path.join(figure_output_dir, "Data_S1_SF17b.csv")
