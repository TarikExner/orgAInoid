...
def _generate_main_figure(rpe_classes_test: pd.DataFrame,
    ...
    def generate_subfigure_a(fig: Figure,
        ...
        accuracy_plot.set_ylabel("F1-score", fontsize = cfg.AXIS_LABELS_SIZE)
...
def generate_bin_dist_figure(sketch_dir: str,
