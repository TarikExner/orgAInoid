...
def _generate_main_figure(
    ...
    def generate_subfigure_a(
        ...
        clf_comp_plot.set_title(
            "Classifier performance for RPE classes", fontsize=cfg.TITLE_SIZE
        )
    ...
    def generate_subfigure_b(
        ...
        clf_comp_plot.set_title(
            "Classifier performance for lens classes", fontsize=cfg.TITLE_SIZE
        )
        clf_comp_plot.set_ylabel("F1 Score", fontsize=cfg.AXIS_LABEL_SIZE)
        clf_comp_plot.set_xticklabels(
            clf_comp_plot.get_xticklabels(),
...
def figure_S15_generation(
    ...
    rpe_output_dir = os.path.join(figure_output_dir, "Extended_Data_50.csv")
    rpe_classes_clf.to_csv(rpe_output_dir, index = False)

    lens_output_dir = os.path.join(figure_output_dir, "Extended_Data_51.csv")
