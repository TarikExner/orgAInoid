...
def figure_S7_generation(
    ...
    **kwargs,
    ...
    rpe_final_output_dir = os.path.join(figure_output_dir, "Data_S1_SF7a.csv")
    ...
    rpe_clf_output_dir = os.path.join(figure_output_dir, "Data_S1_SF7b.csv")
    ...
    lens_final_output_dir = os.path.join(figure_output_dir, "Data_S1_SF7c.csv")
    ...
    lens_clf_output_dir = os.path.join(figure_output_dir, "Data_S1_SF7d.csv")
