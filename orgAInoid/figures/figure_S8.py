...
def generate_subfigure_b(fig: Figure,
    ...
    with open("./figure_data/RPE_classes_classification_test_classifier_confusion_matrices.data", "rb") as file:
    ...
    with open("./figure_data/RPE_classes_classification_val_classifier_confusion_matrices.data", "rb") as file:
...
def generate_subfigure_d(fig: Figure,
    ...
    with open("./figure_data/Lens_classes_classification_test_classifier_confusion_matrices.data", "rb") as file:
        test = pickle.load(file)
        test[["class0", "class1", "class2", "class3"]] = test["percentage_matrix"].apply(
            lambda matrix: pd.Series(utils.classwise_confusion_matrix(matrix))
        )
    with open("./figure_data/Lens_classes_classification_val_classifier_confusion_matrices.data", "rb") as file:
        validation = pickle.load(file)
        validation[["class0", "class1", "class2", "class3"]] = validation["percentage_matrix"].apply(
            lambda matrix: pd.Series(utils.classwise_confusion_matrix(matrix))
        )
...
if __name__ == "__main__":
    ...
    plt.savefig("./prefinal_figures/FigureS8.pdf", dpi = 300, bbox_inches = "tight")
