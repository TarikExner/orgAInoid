...
def figure_S14_generation(
    ...
    **kwargs,
    ...
    rpe_final_output_dir = os.path.join(figure_output_dir, "Data_S47.csv")
    rpe_final_f1s.to_csv(rpe_final_output_dir, index = False)

    rpe_cnn_output_dir = os.path.join(figure_output_dir, "Data_S48.csv")
    ...
    lens_final_output_dir = os.path.join(figure_output_dir, "Data_S49.csv")
    lens_final_f1s.to_csv(lens_final_output_dir, index = False)

    lens_cnn_output_dir = os.path.join(figure_output_dir, "Data_S50.csv")
