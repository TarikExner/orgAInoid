...
def generate_subfigure_a(fig: Figure,
    ...
    neural_net_data = pd.read_csv("./figure_data/RPE_classification/RPE_Final_nexp.txt", index_col = False)
    neural_net_data = _prep_data(neural_net_data)
    neural_net_data = neural_net_data.sort_values(["ValExpID", "n_experiments"], ascending = [True, True])
    neural_net_data["ValExpID"] = neural_net_data["ValExpID"].map(cfg.EXPERIMENT_MAP)

    classifier_data = pd.read_csv("./figure_data/classifier_n_experiments.log", index_col = False)
    classifier_data = classifier_data[classifier_data["readout"] == "RPE_Final"]
    classifier_data = classifier_data.sort_values(["experiment", "n_experiments"], ascending = [True, True])
    ...
    sns.lineplot(data = neural_net_data, x = "n_experiments", y = "ValF1", hue = "ValExpID", ax = nn_plot, errorbar = "se", palette = cfg.EXPERIMENT_LEGEND_CMAP)
    nn_plot.set_title("Prediction accuracy: Emergence of RPE\nin validation organoids by deep learning", fontsize = cfg.TITLE_SIZE)
    ...
    sns.lineplot(data = classifier_data, x = "n_experiments", y = "f1_score", hue = "experiment", ax = clf_plot, errorbar = "se", palette = cfg.EXPERIMENT_LEGEND_CMAP)

    clf_plot.set_title("Prediction accuracy: Emergence of RPE\nin validation organoids by morphometrics", fontsize = cfg.TITLE_SIZE)
    ...
    clf_plot.legend(bbox_to_anchor = (1.01, 0.5), loc = "center left", fontsize = cfg.TITLE_SIZE, **cfg.TWO_COL_LEGEND)
...
def generate_subfigure_b(fig: Figure,
    ...
    neural_net_data = pd.read_csv("./figure_data/Lens_classification/Lens_Final_nexp.txt", index_col = False)
    neural_net_data = _prep_data(neural_net_data)
    neural_net_data = neural_net_data.sort_values(["ValExpID", "n_experiments"], ascending = [True, True])
    neural_net_data["ValExpID"] = neural_net_data["ValExpID"].map(cfg.EXPERIMENT_MAP)
    ...
    nn_plot = fig.add_subplot(fig_sgs[0])
    sns.lineplot(data = neural_net_data, x = "n_experiments", y = "ValF1", hue = "ValExpID", ax = nn_plot, errorbar = "se", palette = cfg.EXPERIMENT_LEGEND_CMAP)
    nn_plot.set_title("Prediction accuracy: Emergence of lenses\nin validation organoids by deep learning", fontsize = cfg.TITLE_SIZE)
    nn_plot.set_ylabel("F1 score", fontsize = cfg.AXIS_LABEL_SIZE)
    nn_plot.set_ylim(-0.1, 1.1)
    nn_plot.tick_params(**cfg.TICKPARAMS_PARAMS)
    nn_plot.set_xlabel("n experiments used for training", fontsize = cfg.AXIS_LABEL_SIZE)    
    ...
    clf_plot.set_title("Prediction accuracy: Emergence of lenses\nin validation organoids by morphometrics", fontsize = cfg.TITLE_SIZE)
    clf_plot.set_ylabel("F1 score", fontsize = cfg.AXIS_LABEL_SIZE)
    clf_plot.set_ylim(-0.1, 1.1)
    clf_plot.tick_params(**cfg.TICKPARAMS_PARAMS)
    clf_plot.set_xlabel("n experiments used for training", fontsize = cfg.AXIS_LABEL_SIZE)    
...
def generate_subfigure_c(fig: Figure,
    ...
    neural_net_data = pd.read_csv("./figure_data/RPE_classes_classification/RPE_classes_nexp.txt", index_col = False)
    neural_net_data = _prep_data(neural_net_data)
    neural_net_data = neural_net_data.sort_values(["ValExpID", "n_experiments"], ascending = [True, True])
    neural_net_data["ValExpID"] = neural_net_data["ValExpID"].map(cfg.EXPERIMENT_MAP)
    ...
    nn_plot = fig.add_subplot(fig_sgs[0])
    sns.lineplot(data = neural_net_data, x = "n_experiments", y = "ValF1", hue = "ValExpID", ax = nn_plot, errorbar = "se", palette = cfg.EXPERIMENT_LEGEND_CMAP)
    nn_plot.set_title("Prediction accuracy: Area of RPE\nin validation organoids by deep learning", fontsize = cfg.TITLE_SIZE)
    nn_plot.set_ylabel("F1 score", fontsize = cfg.AXIS_LABEL_SIZE)
    nn_plot.set_ylim(-0.1, 1.1)
    nn_plot.tick_params(**cfg.TICKPARAMS_PARAMS)
    nn_plot.set_xlabel("n experiments used for training", fontsize = cfg.AXIS_LABEL_SIZE)    
    ...
    clf_plot.set_title("Prediction accuracy: Area of RPE\nin validation organoids by morphometrics", fontsize = cfg.TITLE_SIZE)
    clf_plot.set_ylabel("F1 score", fontsize = cfg.AXIS_LABEL_SIZE)
    clf_plot.set_ylim(-0.1, 1.1)
    clf_plot.tick_params(**cfg.TICKPARAMS_PARAMS)
    clf_plot.set_xlabel("n experiments used for training", fontsize = cfg.AXIS_LABEL_SIZE)    
...
def generate_subfigure_d(fig: Figure,
    ...
    neural_net_data = pd.read_csv("./figure_data/Lens_classes_classification/Lens_classes_nexp.txt", index_col = False)
    neural_net_data = _prep_data(neural_net_data)
    neural_net_data = neural_net_data.sort_values(["ValExpID", "n_experiments"], ascending = [True, True])
    neural_net_data["ValExpID"] = neural_net_data["ValExpID"].map(cfg.EXPERIMENT_MAP)
    ...
    nn_plot = fig.add_subplot(fig_sgs[0])
    sns.lineplot(data = neural_net_data, x = "n_experiments", y = "ValF1", hue = "ValExpID", ax = nn_plot, errorbar = "se", palette = cfg.EXPERIMENT_LEGEND_CMAP)
    nn_plot.set_title("Prediction accuracy: Area of lenses\nin validation organoids by deep learning", fontsize = cfg.TITLE_SIZE)
    nn_plot.set_ylabel("F1 score", fontsize = cfg.AXIS_LABEL_SIZE)
    nn_plot.set_ylim(-0.1, 1.1)
    nn_plot.tick_params(**cfg.TICKPARAMS_PARAMS)
    nn_plot.set_xlabel("n experiments used for training", fontsize = cfg.AXIS_LABEL_SIZE)    
    ...
    clf_plot.set_title("Prediction accuracy: Area of lenses\nin validation organoids by morphometrics", fontsize = cfg.TITLE_SIZE)
    clf_plot.set_ylabel("F1 score", fontsize = cfg.AXIS_LABEL_SIZE)
    clf_plot.set_ylim(-0.1, 1.1)
    clf_plot.tick_params(**cfg.TICKPARAMS_PARAMS)
    clf_plot.set_xlabel("n experiments used for training", fontsize = cfg.AXIS_LABEL_SIZE)    
